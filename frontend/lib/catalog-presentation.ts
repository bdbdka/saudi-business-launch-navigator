...
const portfolioDemoText: Record<Locale, CatalogPresentationPolicy["text"]> = {
  ar: {
    ...
    questionnaireEmptyBody:
      "يمكنك الانتقال إلى قائمة خطواتك مباشرة؛ لا نحتاج إلى إجابات إضافية لهذا النشاط الآن.",
    resultScopeNote:
    ...
    coverageExplanation: "تعرض القائمة الحالات التي تغطيها النسخة الحالية فقط.",
    ...
    noApplicableItems: "لا توجد خطوات إضافية بناءً على إجاباتك الحالية.",
    ...
    unconditionalItem: "أضفنا هذه الخطوة إلى قائمتك لتساعدك على تنظيم البداية.",
  ...
  en: {
    ...
    landingCoverage:
      "The current version covers coffee shops, restaurants, and cloud kitchens in Jeddah and Riyadh only. Local requirements in other Saudi cities have not yet been fully reviewed, so results are not assumed to apply there automatically. Any local differences will be shown only after official-source verification.",
    questionnaireIntro:
    ...
    questionnaireEmptyBody:
      "You can continue to your checklist; we do not need more answers for this activity right now.",
    resultScopeNote:
      "This version uses sample data to demonstrate the guide; its checklist steps are not published official requirements. Use the official activity reference below to review published activity information.",
    ...
    coverageExplanation:
      "The checklist covers only the cases represented in the current version.",
    ...
    noApplicableItems: "No additional steps are shown for your current answers.",
    ...
    unconditionalItem: "We added this step to help you organize the start of your project.",
