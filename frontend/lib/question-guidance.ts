...
const questionGuidance: Record<QuestionFactCode, LocalizedGuidance> = {
  ...
  has_selected_business_premises: {
    ar: {
      prompt: "هل حددت موقعًا معينًا للمشروع أو أدرجته ضمن خياراتك الجدية؟",
  ...
  has_employees: {
    ar: {
      prompt: "هل ستوظف المنشأة موظفين أو عمالًا؟",
      ...
      why: "إذا كنت ستوظف أشخاصًا، فمن المفيد تحديد الأدوار والأعداد المتوقعة قبل مراجعة ترتيبات التوظيف.",
    ...
    en: {
      ...
      why: "If you will employ people, it helps to define the expected roles and headcount before reviewing staffing arrangements.",
  ...
  gosi_coverage_conditions_met: {
    ar: {
      ...
      why: "حتى لا نعرض لك متابعة متعلقة بالتأمينات بناءً على توقع غير مؤكد.",
    ...
    en: {
      ...
      why: "This prevents a GOSI follow-up step from being shown on the basis of an unconfirmed assumption.",
  ...
  has_food_establishment_workers: {
    ar: {
      prompt: "هل سيعمل أي من موظفي المنشأة داخل موقع إعداد أو تقديم الطعام والمشروبات؟",
      ...
      why: "يساعدنا ذلك على فصل العاملين داخل منشأة الطعام عن الموظفين الذين يعملون خارجها.",
    ...
    en: {
      ...
      why: "This separates workers inside the food premises from employees who work elsewhere.",
  ...
  zatca_confirmed_mandatory_vat_registration_applies: {
    ar: {
      ...
      why: "حتى لا نعرض حالة ضريبية مبنية على توقع؛ فإذا لم تتحقق رسميًا فستبقى الحالة غير محسومة.",
    ...
    en: {
      ...
      why: "This avoids showing a tax status based on an assumption; without official confirmation, the status remains unresolved.",
  ...
  offers_home_delivery: {
    ar: {
      ...
      why: "إذا كنت ستقدم التوصيل، فسنضيف خطوة مستقلة لتجميع تفاصيل طريقة التوصيل والأسئلة التي تحتاج إلى مراجعتها.",
    ...
    en: {
      ...
      why: "If you will offer delivery, we add a separate step for organizing the delivery approach and the questions that need review.",
  ...
  uses_public_sidewalk_for_customer_service: {
    ar: {
      prompt: "هل سيستخدم المطعم الرصيف العام أمام الموقع لخدمة العملاء؟",
