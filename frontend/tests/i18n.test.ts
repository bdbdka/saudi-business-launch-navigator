...
describe("locale dictionaries", () => {
  it("provides Arabic-first product copy", () => {
    ...
    expect(copy.about.sourcesPrinciple).toContain("لا نعرض المعلومة على أنها متطلب مؤكد");
    expect(copy.footer.disclaimer).toContain("ليس منصة حكومية");
  ...
  it("provides complete English product copy", () => {
    ...
    expect(copy.about.sourcesPrinciple).toContain("verified requirement");
    expect(copy.footer.disclaimer).toContain("not a government service");
